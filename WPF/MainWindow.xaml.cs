...
namespace WPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void LoadCategoryList()
        {
            ...
            {
                System.Windows.MessageBox.Show(ex.Message, "Error on load list of categories");
            }
        }
        ...
        private void btnUpdate_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    System.Windows.MessageBox.Show("You must select a Product 1");
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    System.Windows.MessageBox.Show("You must select a Product !");
                }
            }
            catch (Exception ex)
            {
